  ...
  return (
    <div className="registration">
      <div className="container">
        <h2 className="title" role="title">Register</h2>
        <Form onSubmit={handleFormSubmit}>
          <h6 className="subtitle">
            Please enter your details below to register yourself.
          </h6>
          {successMsg && <Alert variant="success">{successMsg}</Alert>}
          {errorMsg && <Alert variant="danger" role="alert">{errorMsg}</Alert>}
          ...
          <Form.Group>
            <Button variant="secondary" type="submit" role="onSubmitButton">
              Register
            </Button>
          </Form.Group>
        </Form>
